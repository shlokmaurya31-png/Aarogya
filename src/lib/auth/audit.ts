...
export type AuditEventType =
  ...
  | "hospital.quality.rcaUpdated"
  // Phase C1 — interoperability. Distinct from InteropProvenance: these record
  // what Aarogya DID (linked, granted, exchanged), while provenance records
  // where a clinical representation CAME FROM.
  | "hospital.interop.externalIdentityLinked"
  | "hospital.interop.externalIdentityUnlinked"
  ...
  | "hospital.interop.consentClosed"
  | "hospital.interop.exchangeRequested"
  | "hospital.interop.exchangeAuthorized"
  | "hospital.interop.exchangeRejected"
  | "hospital.interop.exchangeProcessing"
  | "hospital.interop.exchangeCompleted"
  | "hospital.interop.exchangeFailed"
  ...
  // Phase C5 — NHCX claims exchange. Kept in the hospital.claim namespace
  // because these are billing-domain events that happen to cross a
  // protocol boundary, not security events.
  ...
  | "hospital.claim.settlementReconciled"
  | "hospital.claim.reconciliationException"
  | "hospital.claim.manualAdjustment"
  | "hospital.claim.participantMapped"
