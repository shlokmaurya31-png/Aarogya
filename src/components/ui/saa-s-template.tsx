...
const Hero = React.memo(() => {
  return (
    <section
      className="saa-s-template relative min-h-screen flex flex-col items-center justify-start px-6 py-20 md:py-24"
      style={{
      ...
      <div className="w-full max-w-5xl relative pb-20">
        <div
          ...
          style={{
            ...
            background: "radial-gradient(closest-side, rgba(120,200,255,0.35), rgba(120,200,255,0) 70%)",
            height: "420px",
            filter: "blur(40px)"
          }}
          aria-hidden="true"
