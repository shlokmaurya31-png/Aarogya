...
import { Phone, Siren, Ambulance } from "lucide-react";
  ...
  return (
    <div className="space-y-5">
      ...
      <Card className="flex flex-col items-start justify-between gap-4 border-red/20 bg-red/[0.05] sm:flex-row sm:items-center">
        ...
        <button className="w-full shrink-0 rounded-full bg-red px-6 py-2.5 text-[13px] font-semibold text-ink transition hover:brightness-110 active:scale-[0.97] sm:w-auto">
          Trigger SOS
        </button>
      </Card>
      ...
      <Card>
        ...
        <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-2xl bg-white/[0.03] px-3 py-3 text-center">
          ...
          {emergencyContacts.map((c, i) => (
            ...
            >
              <div className="flex items-center gap-3.5">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/[0.05] text-[12px] font-medium text-text-secondary">
